...
import vn.lqh.laptopshop.repository.CartRepository;
import vn.lqh.laptopshop.repository.OrderDetailRepository;
import vn.lqh.laptopshop.repository.OrderRepository;
import vn.lqh.laptopshop.repository.ProductRepository;
import vn.lqh.laptopshop.service.specification.ProductSpecs;
...
public class ProductService {
    ...
    public ProductService(ProductRepository productRepository, CartRepository cartRepository,
            ...
            OrderDetailRepository orderDetailRepository, DaoAuthenticationProvider authProvider, AuthenticationSuccessHandler customSuccessHandler) {
          ...
          if(cart != null){
            List<CartDetail> cartDetails = cart.getCartDetails();
             ...
             if(cartDetails != null){
                ...
                //step2: delete cart _detail and  cart
